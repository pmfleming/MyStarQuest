...
const teenieRoles = {
  ...
  buyRewardIcon: '@gift',
  lockedRewardIcon: 'locked-reward.svg',
  ...
  plateImage: 'plate.svg',
  biteIcon: 'dinner-overview.webp',
  flaskFullImage: 'flask-full.svg',
  flaskTwoThirdsImage: 'flask-twothirds.svg',
  flaskOneThirdImage: 'flask-onethird.svg',
