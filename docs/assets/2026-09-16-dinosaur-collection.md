...
Eighteen paired creatures are available under **Dinosaurs**: twelve dinosaurs, two pterosaurs, one synapsid, one ammonite, one shark and one snake-like squamate. All 15 named taxa on the supplied Bad Dinosaurs checklist are included; Donnie is excluded at the user's request. Brachiosaurus, Mahakala and Spinosaurus extend the collection with the missing named dinosaur genera from PAW Patrol: The Dino Movie. See the [Bad Dinosaurs addition notes](2026-09-16-dinosaur-additions.md) and [PAW Patrol addition notes](2026-09-19-paw-patrol-dinosaurs.md) for artwork provenance and scientific qualifications.
