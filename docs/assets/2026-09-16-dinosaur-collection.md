...
Fifteen paired creatures from the supplied Bad Dinosaurs checklist are available under **Dinosaurs**: nine dinosaurs, two pterosaurs, one synapsid, one ammonite, one shark and one snake-like squamate. All named taxa on the checklist are included; Donnie is excluded at the user's request. See the [addition notes](2026-09-16-dinosaur-additions.md) for artwork provenance and scientific qualifications.
