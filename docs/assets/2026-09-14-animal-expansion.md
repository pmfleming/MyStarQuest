...
The [asset manifest](2026-09-14-animal-expansion.json) records exact species, factual references, saved illustration/photo paths, and the full prompts used with built-in imagegen. Real photographs were downloaded from Wikimedia Commons and resized/encoded as WebP without generative editing. Their original backgrounds are retained. Photo credits and licences are recorded in [Who Am I photo credits](who-am-i-photo-credits.md) and the app's structured credit catalog.

Validation:

- All 22 illustration/photo pairs visually reviewed; every illustration has alpha transparency.
